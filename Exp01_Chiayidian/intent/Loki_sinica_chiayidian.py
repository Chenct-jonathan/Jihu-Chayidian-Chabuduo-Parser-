...
"""
    Loki module for sinica_chiayidian
...
def debugInfo(inputSTR, utterance):
    if DEBUG_sinica_chiayidian:
        print("[sinica_chiayidian] {} ===> {}".format(inputSTR, utterance))
...
def getResult(inputSTR, utterance, args, resultDICT):
    ...
    if utterance == "[三個][年輕人][差一點]就要去大鬧[天宮]":
        # write your code here
        pass

    if utterance == "[只][差一點]沒和那[漂亮][女人]做成[一回][好事]":
        # write your code here
        pass
    ...
    if utterance == "又曾經在泳渡[深潭]時[不慎]捲入[旋渦][差一點]溺死":
        # write your code here
        pass
    ...
    if utterance == "最後還[差一點]就當選[高雄區]的[立法委員]":
        # write your code here
        pass
